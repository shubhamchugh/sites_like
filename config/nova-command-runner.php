...
return [
    ...
    'commands'         => [
        ...
        'Config Cache'             => ['run' => 'config:cache', 'type' => 'primary', 'group' => 'Cache'],
        'Route Clear'              => ['run' => 'route:clear', 'type' => 'primary', 'group' => 'Cache'],
        'Optimize Clear'           => ['run' => 'optimize:clear', 'type' => 'primary', 'group' => 'Cache'],
        'composer Autoload'        => ['run' => 'composer dump-autoload', 'command_type' => 'bash', 'type' => 'warning', 'group' => 'Cache'],
        'composer update'          => ['run' => 'COMPOSER_MEMORY_LIMIT=-1 composer update', 'command_type' => 'bash', 'type' => 'warning', 'group' => 'Cache'],
